...
public class SuperPush {
  ...
  public static void main(String[] args) throws java.io.IOException {
    ...
    try {
      ...
      pruebaSilenciosa(new MensajeProtocolo(Primitiva.HELLO, user));
      
      //Se añade a la cola.
      prueba(new MensajeProtocolo(Primitiva.PUSH, clave, valor));
  ...
  */
  static void pruebaSilenciosa(MensajeProtocolo mp) throws java.io.IOException,
	      MalMensajeProtocoloException, ClassNotFoundException {
    oos.writeObject(mp);
    ois.readObject();
  }
