...
public class Sirviente implements Runnable, AutoCloseable {
    ...
    public void finHilo(){
        ...
        /* El getRemoteSocketAddres deuvelve tipo: /x.x.x.x:x
         * por lo que haciento un split de "/" y quedandote con la segunda 
         * parte te queda x.x.x.x:x y haciendo un split de ":" y quedandote con 
         * la primera parte te queda x.x.x.x que ya seria la IP como tal.
        */
