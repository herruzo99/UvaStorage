...
public class Cliente {
  ...
  public static void main(String[] args) throws java.io.IOException {
    ...
    try {
      ...
      prueba(new MensajeProtocolos(Primitiva.HELLO, "root"));
      
      prueba(new MensajeProtocolos(Primitiva.PUSH, "010", "abc"));

      prueba(new MensajeProtocolos(Primitiva.PULL_NOWAIT, "010"));

      prueba(new MensajeProtocolos(Primitiva.HELLO, "rooot"));

      prueba(new MensajeProtocolos(Primitiva.PUSH, "010", "abc"));

      prueba(new MensajeProtocolos(Primitiva.PULL_NOWAIT, "010"));
      
      prueba(new MensajeProtocolos(Primitiva.PUSH, "01000", "abc"));

      prueba(new MensajeProtocolos(Primitiva.PULL_NOWAIT, "01000"));
